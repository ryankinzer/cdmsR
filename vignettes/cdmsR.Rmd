...
```{r}
activity_details <- getDetailRecords(activityID = 43954, cdms_host = "https://cdms.nptfisheries.org")
head(activity_details)
```

```{r}
dataset <- getProjectData(datasetID = 4334, cdms_host = "https://cdms.nptfisheries.org")
head(dataset)
```
